    ...
    <div className="home">
      ...
      <main className="grid">
        ...
        <section className="search-section">
          <div className="flex flex-row items-center flex-nowrap gap-1.5">
            <Input type="text" id="eventname" placeholder="Rechercher..." />
            <Input type="text" id="place" placeholder="Lieu..." />
            <Select>
        ...
        <section className="event-list">
          <div className="relative flex flex-col my-1 bg-white shadow-sm border border-slate-200 rounded-lg w-72">
